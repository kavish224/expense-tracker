...
export default function Accounts() {
    ...
    return (
        <main className="mx-auto max-w-lg px-4 py-6 space-y-6 mb-20">
            ...
            <div className="p-4 rounded-xl bg-[var(--color-surface2)] flex gap-4 border border-[var(--color-border2)] shadow-sm">
                <div className="text-[color:var(--color-accent)] shrink-0 mt-0.5">
                ...
                <div className="space-y-1">
                    <p className="text-[12px] font-bold text-[var(--color-text-primary)] uppercase tracking-wider">Account Management</p>
                    <p className="text-[11px] text-[var(--color-text-secondary)] leading-relaxed font-medium">
                        Custom accounts allow you to track spending specifically for different Bank Accounts or Credit Cards.
                        Deleting an account will unpair it from past expenses but won't delete the expenses themselves.
                    </p>
                </div>
            </div>
        </main>
